...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Confidential incident reporting for Seth M.R. Jaipuria School, by the Digital Campaign Club. Submit a report privately and track replies." },
